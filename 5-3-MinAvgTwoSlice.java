...
PROBLEM DESCRIPTION (Source: https://app.codility.com/programmers/lessons/5-prefix_sums/min_avg_two_slice/)
...
class Solution {
    public int solution(int[] A) {
        ...
        for(int currrentIndex = 0; currrentIndex < A.length; currrentIndex++;){
            if(){
